...
import useEmbodiedTimeline from "./embodied/useEmbodiedTimeline";
      ...
      <XRInteraction
        ...
        onGrabStart={(e) => {
          ...
          if (rightHandSelected.current && leftHandSelected.current) {
            ...
            grabbingController.current = e.input;
            previousTransform.copy(e.input.matrixWorld).invert();
          }
        }}
        onGrabEnd={(e) => {
          if (e.handedness === "right") {
          ...
          if (e.input === grabbingController.current) {
            grabbingController.current = undefined;
          }
        }}
      >
        <Graph dim={InitialRequest_ClientViewType.VIEW_3D} />
      </XRInteraction>
    );
  }
);
